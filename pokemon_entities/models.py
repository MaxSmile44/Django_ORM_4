...
class Pokemon(models.Model):
    """Покемон"""
    previous_evolution = models.ForeignKey('self', verbose_name='В кого эволюционирует',
                                  related_name="next_evolution", on_delete=models.SET_NULL, null=True, blank=True)
