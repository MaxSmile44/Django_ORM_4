...
class Pokemon(models.Model):
    """Покемон"""
    next_evolution = models.ForeignKey('self', verbose_name='В кого эволюционирует',
                                  related_name="previous_evolution", on_delete=models.SET_NULL, null=True, blank=True)
